...
export default function ScrapingPopup({}) {
  ...
  return (
    <div className='absolute w-[19rem] mob:w-[30rem] tab:w-[30rem] p-4 h-[15rem] rounded-md border left-1/2 mt-40 z-40 transform -translate-x-1/2 -translate-y-1/2  bg-white'> 
