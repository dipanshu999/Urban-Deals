...
export default function Card({item,handleLikeClick}) {
  ...
  return (
    <div className='relative  hover:scale-110  transition-transform ' >
        ...
        <div className={`${darkMode &&  'border border-white shadow-white shadow-md'} bg-white card h-[14em] w-[9.2em] shadow-xl xsm:h-[14em] xsm:w-[9.78em] mob:h-[14em] mob:w-[10.5em] lap:h-[16em] lap:w-[12em] border border-gray-300 shadows rounded-xl overflow-hidden`}> 
