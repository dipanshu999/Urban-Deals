...
export default function Card({item}) {
  ...
  return (
    <>
        <div className={`${darkMode &&  'border border-white shadow-white shadow-md'} hover:scale-110 transition-transform bg-white card h-[14em] w-[9.2em] shadow-xl xsm:h-[14em] xsm:w-[9.78em] mob:h-[14em] mob:w-[10.5em] lap:h-[16em] lap:w-[12em] border border-gray-300 shadows rounded-xl overflow-hidden`}> 
            ...
            <div className="card-footer bg-[#FEDC00] pl-1 h-[30%] flex flex-col justify-between gap-1 ">
              <div className=' h-[60%] flex items-center overflow-y-hidden '>
                <p className='TITLE text-[#7924DE] text-[1em] lap:text-[1.2em] font-medium leading-4'>{truncatedTitle}</p>
              </div>
